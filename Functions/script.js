...
Function Declaration - a way to define a named function that allows you to create reusable blocks of code that can be called and executed at any point
in your program. Here's basic syntax for a function declaration:

function functionName(parameters) {
    // code to be executed
}

1. 'function' = keyword that tells JS you're declaring a function
2. 'functionName' = name of the function
3. 'parameters' = optional placeholders for values that the function can accept as input. You can define multiple parameters by separating them
with commas. If your function doesn't require any parameters, you can omit the parentheses but they are still required when declaration the function
4. 'code to be executed' = block of code that will be executed whenever the function is called
...
The function named 'addNumbers' takes 2 parameters 'a' and 'b'. Inside the function the sum of 'a' and 'b' is calculated and printed to the console
using 'console.log'. Once you've declared the function you can call it by using its name followed by () and you can pass arguments (actual values)
to the function if it expects parameters

addNumbers(5,7);    // Outputs: 12

By calling 'addNumbers(5,7)' you're invoking the 'addNumbers' function and passing the values 5 and 7 as arguments. The function will execute its code
and log the sum of the two numbers, which is 12, to the console. Function declarations are hoisted in JS which means they can be called before they are
declared in the code which allows you to define functions anywhere in your code, even after you've called them. 
